%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calculation of SD and STD for Nodes
%
...
listCCs_gpBtp2 = listCCs_gpytp2;listFMs_gpBtp2 = listFMs_gpytp2; 
            ...
            %%%%%%%%%%%%%%% COMMON CODE %%%%%%%%%%%%%%%%%%%
%% Computation System and Spatio-Temporal Diversity
...
ts_gpA_struc = ts_CC_gpA;
ts_gpB_struc = ts_CC_gpB;
% longitudinal
ts_gpAtp2_struc = ts_CC_gpAtp2;
ts_gpBtp2_struc = ts_CC_gpBtp2; 



[SD_gpA,~,SD_prob_gpA]  = system_diversity(listCCs_gpA, ts_gpA_struc, scale);
[SD_gpB,~,SD_prob_gpB]  = system_diversity(listCCs_gpB, ts_gpB_struc, scale);

TD_gpA = temporal_diversity(listFMs_gpA, ts_gpA_struc);
TD_gpB = temporal_diversity(listFMs_gpB, ts_gpB_struc);

% longitudinal

[SD_gpAtp2,~,SD_prob_gpAtp2]  = system_diversity(listCCs_gpAtp2, ts_gpAtp2_struc, scale);
[SD_gpBtp2,~,SD_prob_gpBtp2]  = system_diversity(listCCs_gpBtp2, ts_gpBtp2_struc, scale);
TD_gpAtp2 = temporal_diversity(listFMs_gpAtp2, ts_gpAtp2_struc);
TD_gpBtp2 = temporal_diversity(listFMs_gpBtp2, ts_gpBtp2_struc);

%% Permutation of the CCs
SD_gp2 = zeros(1,nb_struct,nb_permutations);
TD_gp2 = zeros(1,nb_struct,nb_permutations);
...
% note: plotting SD_ent_gpA, SD_ent_gpB, TD_gpA, TD_gpB